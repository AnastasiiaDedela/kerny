    ...
    <div className="flex flex-col gap-2.5">
      {table.getRowModel().rows.map((row) => (
        <div key={row.id}>
          ...
          <div className="flex flex-col gap-3 rounded-[10px] bg-white/[0.04] p-4 lg:hidden">
            ...
            {row.getVisibleCells().map((cell) => (
              <div
                key={cell.id}
                className="flex items-center justify-between rounded-[5px] border-[0.5px] border-white/30 px-3 py-2.5"
              >
          ...
          {/* Desktop: full row */}
          <div className="hidden h-[86px] items-center justify-between rounded-[10px] bg-white/[0.04] pr-[23px] pl-5 lg:flex">
